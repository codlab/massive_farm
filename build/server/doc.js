...
function generate(config) {
    ...
    return (req, res) => {
        ...
        config === null || config === void 0 ? void 0 : config.routes.forEach(route => {
            var _a;
            const routeAction = route;
            const routeFile = route;
            const isFile = !!(routeFile === null || routeFile === void 0 ? void 0 : routeFile.path);
            ...
            (_a = routeAction === null || routeAction === void 0 ? void 0 : routeAction.options) === null || _a === void 0 ? void 0 : _a.forEach(option => {
                get.parameters.push({
                    "name": option.key,
                    "in": "params",
